...
export default function CommonFour(){
	return(
		<section className={style.commonThree}>
			<div className="container">
				<div className="row">
					<div className="col-lg-12">
						<div className="section-heading commonheading">
							<h2><a href="#"><i className="fas fa-angle-double-right"></i>ক্যাম্পাস</a></h2>
						...
						<div className={style.commonThree_big}>
							<a href="#">
								...
								<div className={style.Desc}>
									<h3 className={style.Title2}><span>প্রতিযোগিতামূলক চাকরির প্রস্তুতি /</span> যেভাবে শুরু করবেন</h3>
									<p className={style.leadNewsTop2Time}><i className="far fa-clock"></i>আপডেট ০৮ জানুয়ারি ২৩ । ১৯:০০</p>
								</div>
							</a>
						</div>
					</div>
