...
import Imag1 from '../../assets/images/lanset-bayjid-samakal-63babd7d292c0.webp'
import Imag2 from '../../assets/images/Bebichok-samakal-603aa92243539-samakal-63bab781e9dd5.webp'
import Imag3 from '../../assets/images/Untitled-29-samakal-63b9d5e81b758.jpg'
import Imag4 from '../../assets/images/jamuka-samakal-63ba968eca6a7.webp'

export default function CommonOne(){
	return(
				...
				<div className="row">
					<div className="col-lg-12">
						<div className="section-heading">
							<h2><a href="#"><i className="fas fa-angle-double-right"></i>বাংলাদেশ</a></h2>
